function Footer() {
  try {
    ...
    return (
      <footer
        className="py-16"
        style={{ backgroundColor: '#003540', color: '#D9C57C' }}
        data-name="footer"
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p
                ...
                style={{ color: 'rgba(217, 197, 124, 0.8)' }}
              >
                iDigitalWorks - Professional WhatsApp account recovery service
                helping thousands of Indian users regain access to their banned
                accounts safely and quickly.
              </p>
              ...
              <ul className="space-y-2">
                <li>
                  <button
                    ...
                    style={{ color: 'rgba(217, 197, 124, 0.8)' }}
                    onMouseOver={(e) => (e.target.style.color = '#D9C57C')}
                    onMouseOut={(e) =>
                      (e.target.style.color = 'rgba(217, 197, 124, 0.8)')
                    }
                  >
                    Home Page
                  </button>
          ...
          <div className="border-t border-white/20 mt-12 pt-8 text-center">
            <p style={{ color: 'rgba(217, 197, 124, 0.8)' }}>
              © 2025 iDigitalWorks. All rights reserved. Not affiliated with
              WhatsApp Inc.
            </p>
          </div>
        </div>
